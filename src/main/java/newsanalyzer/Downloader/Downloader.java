...
public abstract class Downloader {
    ...
    public abstract int process(List<String> urls) throws IOException, NewsAnalyserException;

    public String saveUrl2File(String urlString) throws IOException, NewsAnalyserException{
        InputStream is = null;
        ...
        try {
            ...
            //e.printStackTrace();
            throw new NewsAnalyserException("Problem with File:" + fileName);
